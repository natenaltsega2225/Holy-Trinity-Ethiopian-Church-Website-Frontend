...
//   const start = row.start_date ? fmt(row.start_date) : null;
//   const end = row.end_date ? fmt(row.end_date) : null;
...
//         {rows.map((row) => {
//           const flyerUrl = normalizeMediaUrl(
//             row.flyer_image_url || row.flyer_url
//           );
//           const pdfUrl = normalizeMediaUrl(row.program_pdf_url || row.pdf_url);

//           return (
//             <article key={row.id} className="cat-event-card">
//               {/* LEFT – banner / flyer image (dynamic height with placeholder) */}
...
//                     <div className="cat-ph-sub">
//                       Banner image / program flyer
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//                     )}
//                     {formatDateRange(row) && (
//                       <div className="cat-event-date-line">
//                         {formatDateRange(row)}
//                         {row.start_time && (
...
//                   {/* PDF resources pill – looks good even when empty */}
//                   <div className="cat-event-header-meta">
//                     <div className="cat-pdf-label">PDF RESOURCES</div>
//                     <button
//                       type="button"
//                       className={
//                         "cat-pdf-card" + (!pdfUrl ? " cat-pdf-card-disabled" : "")
//                       }
//                       onClick={() => {
//                         if (!pdfUrl) return;
...
//                         <div className="cat-pdf-title">
//                           {pdfUrl ? "Program / flyer PDF" : "No PDF uploaded yet"}
//                         </div>
//                         <div className="cat-pdf-sub">
//                           {pdfUrl
//                             ? "Click to read, print, or download."
//                             : "When a note or flyer is attached it will appear here."}
//                         </div>
//                       </div>
//                     </button>
//                   </div>
...
//                     <button
//                       type="button"
//                       className="cat-event-link-btn"
//                       onClick={() =>
//                         window.open(flyerUrl, "_blank", "noopener")
//                       }
//                     >
//                       Open banner / flyer image →
//                     </button>
//                   )}
//                   {!pdfUrl && (
//                     <span className="cat-event-note">
//                       No PDF note is currently attached for this item.
//                     </span>
//                   )}
//                 </footer>
//               </div>
