...
// /* --------------------------------------------------
//    Helper – turn relative paths into full URLs
//    e.g. "/uploads/…"  => "http://localhost:5000/uploads/…"
// -------------------------------------------------- */
...
// /* --------------------------------------------------
//    WYSIWYG Editor – Word-style toolbar (no extra deps)
// -------------------------------------------------- */
// function WysiwygEditor({ label, value, onChange, placeholder }) {
//   const editorRef = useRef(null);

//   // keep DOM in sync when opening "Edit"
//   useEffect(() => {
...
//     } catch (err) {
//       console.warn("execCommand failed", cmd, arg, err);
//     }
//   };
...
//           A
//         </button>
//         <button type="button" onClick={() => exec("hiliteColor", "#fff7c2")}>
//           ✺
//         </button>
...
//   const start = row.start_date ? format(row.start_date) : null;
//   const end = row.end_date ? format(row.end_date) : null;
...
//                   r.flyer_url || r.flyer_image_url
//                 );
//                 const pdfUrl = normalizeMediaUrl(
//                   r.pdf_url || r.program_pdf_url
//                 );
...
//                   placeholder="Short teaser shown on the public cards."
//                 />
...
//                   placeholder="Full description, schedule, and notes."
//                 />
...
//                     />
//                     <small className="field-note">
//                       Optional PDF note visible on the public page.
//                     </small>
//                   </div>
//                 </div>
